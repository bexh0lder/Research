...
models=(
    ...
    "/work/xzh/SPV-MIA/ft_llms/falcon-7b/ag_news/target/2500-overfitting/checkpoint-5000/epoch25-merge"
    "/work/xzh/SPV-MIA/ft_llms/falcon-7b/ag_news/target/5000-overfitting/checkpoint-8320/epoch20-merge"
    # 可以添加更多模型：
    # "/path/to/model1"
    # "/path/to/model2"
)
